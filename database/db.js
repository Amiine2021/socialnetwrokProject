...
const bcrypt = require('../server/bc');

const db = spicedPg(process.env.DATABASE_URL || `postgres:amine:postgres@localhost:5432/socialnetwork`);
...
module.exports.getlogin = (email,password)=>{
    return db.query(`
